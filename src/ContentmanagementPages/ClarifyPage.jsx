      ...
      {open && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl w-[95%] max-w-xl p-6 relative">
            ...
            <h2 className="text-lg font-semibold mb-3">Add Strategies</h2>
      ...
      {isEdit && selectedData && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl w-[95%] max-w-xl p-6 relative">
            ...
            <h2 className="text-lg font-semibold mb-3">Update Strategies</h2>
