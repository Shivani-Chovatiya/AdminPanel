...
const FreeAssessmentsPage = () => {
  const contents = [
    {
      title: "ABC",
      teges: "Mental Health/Common",
      line: "Daily Horoscope",
    },
    {
      title: "ABC",
      teges: "Mental Health/Common",
      line: "Weekly Prediction",
    },
    {
      title: "ABC",
      teges: "Mental Health/Common",
  ...
  useEffect(() => {
    if (isEdit && selectedData) {
      ...
      setDescription(selectedData.line || "");
      setTegs(selectedData.teges);
    }
  }, [isEdit, selectedData]);
          ...
          <tbody>
            {paginatedData.map((c, i) => (
              <tr key={i + 1} className="border-b">
                ...
                <td className="p-2">{c.line}</td>
                <td className="p-2">{c.teges}</td>
                <td className="p-2">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Mental Health/Common">
