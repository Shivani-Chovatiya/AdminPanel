          ...
          {sessions.map((session) => (
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="space-y-2">
                  <h2 className="text-xl md:text-2xl font-semibold">
                    ...
                    <span className="font-bold">{session.name}</span> at{" "}
                    {session.time}
                  </h2>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-orange-100 border border-orange-600 rounded-xl p-4">
                ...
                <button className="bg-orange-600 text-white rounded-lg px-4 py-2 text-sm md:text-base hover:bg-orange-700 transition">
                  + Add Link
                </button>
              </div>
            </div>
